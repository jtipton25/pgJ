...
function update_tuning_mv(k, accept, lambda, batch_samples, Sigma_tune, Sigma_tune_chol)
    ...
    Sigma_tune_out = Sigma_tune + gamma1 * (batch_samples_tmp' * batch_samples_tmp / (50.0 - 1.0) - Sigma_tune)
    Sigma_tune_chol_out = cholesky(Sigma_tune)
    accept_out = 0.0
